...
public class MainActivity extends AppCompatActivity {
    ...
    public void endgame(View view) {
       ...
       EditText teamA = findViewById(R.id.nameofteamA);

       String nameA = teamA.getText().toString()+ " WINS!";

        EditText teamB = findViewById(R.id.nameofteamB);

        String nameB = teamB.getText().toString() + " WINS!";
...
if(finalScoreA>finalScoreB) {
    ...
    Toast toast= Toast.makeText(this, nameA, Toast.LENGTH_SHORT);
    toast.setGravity(Gravity.TOP | Gravity.LEFT, 20, 300);//offsets based off screen placement on lg aristo 2
toast.show();
}
        if(finalScoreA<finalScoreB) {
         Toast toast=Toast.makeText
                    (this, nameB, Toast.LENGTH_SHORT);
         toast.setGravity(Gravity.TOP|Gravity.RIGHT,20,300);//offsets based off screen placement of lg aristo 2
